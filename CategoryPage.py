...
def extract_transform_load_one_book_infos(book, nameFile):
    ...
    BookPage.extract_transform_load_all_infos_in_csv(book_page_url, nameFile)
...
def extract_transform_load_all_books_infos_from_category(product_category_url, file_csv_name):
    ...
    while (category_soup):
        ...
        for book_article in all_books_category_article:
            extract_transform_load_one_book_infos(book_article, file_csv_name)
