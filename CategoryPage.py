...
def extract_transform_load_one_book_infos(book, nameFile, category_name):
    ...
    BookPage.extract_transform_load_all_infos_in_csv(book_page_url, nameFile, category_name)
...
def extract_transform_load_all_books_infos_from_category(product_category_url, file_csv_name, category_name):
    ...
    while (category_soup):
        ...
        for book_article in all_books_category_article:
            extract_transform_load_one_book_infos(book_article, file_csv_name, category_name)
